<?php  
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql3="SELECT * FROM shop_cart WHERE user_id=" . $row["id"] . " AND product_id=1 ";
      ...
      if($count == 1) {
        ...
        $sql2="UPDATE shop_cart set cantitate=cantitate+" . $cantitate . " WHERE user_id=" . $row['id'] . " AND product_id=1";
        $result2=mysqli_query($db,$sql2);
        header("location: cart.php");}
      else{
      $cantitate=$_POST["cantitate"];
	    $sql2="INSERT INTO shop_cart (user_id, product_id, cantitate) values (" . $row['id'] . ",1," . $cantitate . ")";
      $result2=mysqli_query($db,$sql2);
      header("location: cart.php");
    }
   }
...
?>
    ...
    <div class= "small-container single-product" >
        <div class="row">
            <div class="col-2">
                <img src="images/almond_soap.jpg" width="100%" class="product-img">
            </div>
            <div class="col-2">
                <form action="" method="POST">
                <input style="display:none" value=1>
                      <h1 class="product-title">Chamomile Soap</h1>
                      <h4 class="price">50.00 RON</h4>
