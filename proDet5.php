<?php  
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql3="SELECT * FROM shop_cart WHERE user_id=" . $row["id"] . " AND product_id=5 ";
      ...
      if($count == 1) {
        ...
        $sql2="UPDATE shop_cart set cantitate=cantitate+" . $cantitate . " WHERE user_id=" . $row['id'] . " AND product_id=5";
        $result2=mysqli_query($db,$sql2);
        header("location: cart.php");}
      else{
      $cantitate=$_POST["cantitate"];
	    $sql2="INSERT INTO shop_cart (user_id, product_id, cantitate) values (" . $row['id'] . ",5," . $cantitate . ")";
      $result2=mysqli_query($db,$sql2);
      header("location: cart.php");
    }
   }
...
?>
    ...
    <div class= "small-container single-product" >
        <div class="row">
            <div class="col-2">
                <img src="images/coconut.jpg" width="100%" class="product-img">>
            </div>
            <div class="col-2">
               <form action="" method="POST">
                <h1 class="product-title">Coconut Milk Soap</h1>
